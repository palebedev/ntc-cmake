...
if(NTC_DEV_BUILD)
    ...
    function(_ntc_try_append_cxx_flag FLAG)
        ntc_check_cxx_compiler_flag("${FLAG}" var_name)
        if(${var_name})
    ...
    function(_ntc_try_append_linker_flag FLAG)
        ntc_check_linker_flag("${FLAG}" var_name)
        if(${var_name})
    ...
    if(CMAKE_BUILD_TYPE MATCHES "Release|MinSizeRel|RelWithDebInfo")
        ...
        set(NTC_BOOST_DEFINITIONS BOOST_DISABLE_ASSERTS BOOST_HANA_CONFIG_DISABLE_CONCEPT_CHECKS BOOST_EXCEPTION_DISABLE)
    ...
    if(CMAKE_C_COMPILE_OPTIONS_IPO MATCHES thin OR CMAKE_CXX_COMPILE_OPTIONS_IPO MATCHES thin)
        _ntc_try_append_linker_flag("-Wl,--thinlto-cache-dir=${CMAKE_BINARY_DIR}/.thinlto-cache")
    endif()
    ...
    set(NTC_QT_DEFINITIONS QT_DISABLE_DEPRECATED_BEFORE=0x050e00
